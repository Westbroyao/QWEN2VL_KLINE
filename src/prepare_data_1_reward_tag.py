...
# 读取 npz
data = np.load("data_proc/btc_windows_30_5.npz", allow_pickle=True)
...
# 如果你希望保存新的 npz：
np.savez("data_proc/btc_windows_30_5_with_labels.npz",
         X=X,
         y=y,
         time_index=time_index,
         labels_int=labels_int,
         labels_str=labels_str)
print("已保存到 data_proc/btc_windows_30_5_with_labels.npz")